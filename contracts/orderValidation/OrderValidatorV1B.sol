 ...
 * @notice This contract is used to check the validity of a maker order in the ExchangeProtocol.
...
contract OrderValidatorV1B {
    ...
    constructor(address _exchange) {
        ...
        DOMAIN_SEPARATOR = GUNftMarketplaceExchange(_exchange).DOMAIN_SEPARATOR();
