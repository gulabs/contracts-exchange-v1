...
import {IGUNftMarketplaceExchange} from "./interfaces/IGUNftMarketplaceExchange.sol";
...
/**
 * @title GUNftMarketplaceExchange
 * @notice It is the core contract of the exchange.
 */
contract GUNftMarketplaceExchange is IGUNftMarketplaceExchange, ReentrancyGuard, Ownable {
    ...
    constructor(
        ...
        DOMAIN_SEPARATOR = keccak256(
            abi.encode(
                ...
                0x241bc4ad8fc45d3cbcfa9ae0f941ed1be2deac941487832dbdba9b0a408e940a, // keccak256("GUNftMarketplaceExchange")
