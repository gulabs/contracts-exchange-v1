...
describe("LooksRare Exchange", () => {
  ...
  describe("#4 - Standard logic revertions", async () => {
    it("One Cancel Other - Initial order is not executable anymore", async () => {
      ...
      await assertOrderValid(adjustedMakerAskOrder, orderValidatorV1);
      ...
      await assertErrorCode(initialMakerAskOrder, NONCE_EXECUTED_OR_CANCELLED, orderValidatorV1);
  ...
  describe("#5 - Unusual logic revertions", async () => {
    ...
    it("SignatureChecker - Cannot match if v parameters is not 27 or 28", async () => {
      ...
      makerAskOrder.v = 29;
      await assertErrorCode(makerAskOrder, INVALID_V_PARAMETER_EOA, orderValidatorV1);
    ...
    it("SignatureChecker - Cannot match if invalid s parameter", async () => {
      ...
      await assertErrorCode(makerAskOrder, INVALID_S_PARAMETER_EOA, orderValidatorV1);
